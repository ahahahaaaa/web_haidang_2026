...
import { initFrontsiteRecaptchaV3 } from './front/frontsite-recaptcha-v3';
import { initCustomerLoyaltyRedemptions } from './front/customer-loyalty-redemption';
import { initHomePopupSlider } from './front/home-popup-slider';
import { initTravelInquiryModal } from './front/travel-inquiry-modal';
import { initVoucherCountdowns } from './front/voucher-countdown';
import { initVoucherRedemptions } from './front/voucher-redemption';
...
function bootFrontsiteRuntime() {
    ...
    initFrontsiteRecaptchaV3();
    initCustomerLoyaltyRedemptions();
    initFrontsiteAjaxForms();
    initHomePopupSlider();
    initTravelInquiryModal();
    initVoucherCountdowns();
    initVoucherRedemptions();
