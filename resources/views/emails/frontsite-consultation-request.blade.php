...
<html lang="vi">
    ...
    <body style="margin:0;padding:24px;background:#f4f7fb;font-family:Arial,sans-serif;color:#0f172a;">
        <div style="max-width:680px;margin:0 auto;background:#ffffff;border-radius:24px;padding:32px;border:1px solid #e2e8f0;">
            <p style="margin:0 0 8px;font-size:12px;letter-spacing:0.18em;text-transform:uppercase;color:#dc2626;">Frontsite Consultation</p>
            <h1 style="margin:0 0 12px;font-size:28px;line-height:1.2;">Yêu cầu tư vấn mới từ website</h1>
            <p style="margin:0 0 24px;font-size:15px;line-height:1.7;color:#475569;">
                {{ $companyName }} vừa nhận được một yêu cầu tư vấn từ popup liên hệ dùng chung trên frontsite.
            </p>

            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
                @foreach ([
                    'Ngữ cảnh' => $payload['context_label'] ?: 'Frontsite',
                    'Họ tên' => $payload['name'],
                    'Số điện thoại' => $payload['phone'],
                    'Email' => $payload['email'],
                    'Trang gửi' => $payload['page_url'] ?: 'Đang cập nhật',
