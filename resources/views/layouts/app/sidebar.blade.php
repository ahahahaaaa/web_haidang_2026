        ...
        <flux:sidebar sticky collapsible="mobile" class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            >
                <div class="mt-3 rounded-[28px] border border-zinc-200 bg-white/85 p-2 shadow-sm dark:border-zinc-800 dark:bg-zinc-950/40">
                    ...
                    <div class="mt-2 border-t border-zinc-200/70 pt-2 dark:border-zinc-800/80">
                        <a
                            href="https://dashboard.haidangtravel.com"
                            target="_blank"
                            rel="noopener noreferrer"
                            class="flex items-center gap-3 rounded-2xl px-3 py-2.5 text-sm font-semibold text-zinc-700 transition hover:bg-zinc-100 hover:text-zinc-900 dark:text-zinc-200 dark:hover:bg-zinc-800/80 dark:hover:text-white"
                        >
                            <span class="inline-flex h-9 w-9 items-center justify-center rounded-2xl bg-zinc-100 text-zinc-700 dark:bg-zinc-800 dark:text-zinc-200">
                                <i class="fa-solid fa-arrow-up-right-from-square"></i>
                            </span>
                            <span>App quản lý</span>
                        </a>
                    </div>
                </div>
            </flux:sidebar.nav>
