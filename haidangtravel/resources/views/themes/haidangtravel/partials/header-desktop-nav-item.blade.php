...
@if ($hasChildren)
    <div class="group relative">
        ...
        <div class="invisible pointer-events-none absolute left-1/2 top-full z-20 -translate-x-1/2 pt-3 opacity-0 transition duration-200 group-hover:visible group-hover:pointer-events-auto group-hover:opacity-100 group-focus-within:visible group-focus-within:pointer-events-auto group-focus-within:opacity-100">
            <div class="translate-y-2 rounded-3xl border border-slate-200/80 bg-white p-3 shadow-[0_28px_70px_-36px_rgba(15,23,42,0.5)] transition duration-200 group-hover:translate-y-0 group-focus-within:translate-y-0">
