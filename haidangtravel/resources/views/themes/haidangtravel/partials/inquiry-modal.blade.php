...
<div
    ...
    data-default-subject="Tư vấn du lịch"
    data-default-title="Thông tin đặt tour"
    data-default-description="Điền nhanh thông tin đặt tour để Hải Đăng Travel liên hệ và tư vấn đúng nhu cầu của bạn."
...
>
    ...
    >
        ...
        <form action="{{ route('travel-inquiries.store') }}" method="POST" class="mt-6 grid gap-5" data-frontsite-ajax-form novalidate>
            @csrf
