@php
    ...
    $trackedFields = ['form', 'inquiry_type', 'customer_name', 'customer_email', 'customer_phone', 'adult_guest_count', 'party_size', 'address', 'subject', 'message'];
...
<div id="travel-inquiry-form" class="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-[0_30px_80px_-40px_rgba(15,23,42,0.35)] sm:p-8">
    ...
    <form action="{{ route('travel-inquiries.store') }}" method="POST" class="grid gap-5" data-frontsite-ajax-form novalidate>
        @csrf
