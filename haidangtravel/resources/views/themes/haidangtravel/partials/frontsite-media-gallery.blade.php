...
@php
    ...
    $thumbRailClasses = $useDesktopVerticalThumbs
        ? 'frontsite-soft-scrollbar frontsite-soft-scrollbar--inverse overflow-x-auto pb-2 lg:h-full lg:max-h-[38rem] lg:overflow-y-auto lg:overflow-x-hidden lg:pr-1 lg:pb-0'
        : 'frontsite-soft-scrollbar frontsite-soft-scrollbar--inverse overflow-x-auto pb-2';
                                ...
                                >
                                    ...
                                    @foreach ($galleryItems as $item)
                                        <button
                                            ...
                                            data-tour-gallery-description="{{ $item['resolved_description'] }}"
                ...
                <div class="hidden" aria-hidden="true" data-gallery-collection="{{ $resolvedCollectionKey }}">
                    @foreach ($galleryItems as $item)
                        <button
                            ...
                            data-gallery-description="{{ $item['resolved_description'] }}"
