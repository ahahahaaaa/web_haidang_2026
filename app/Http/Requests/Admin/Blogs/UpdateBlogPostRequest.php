...
class UpdateBlogPostRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'country_destination_id' => ['sometimes', 'nullable', 'integer', Rule::exists('destinations', 'id')->where('is_country_root', true)],
            'destination_id' => ['sometimes', 'nullable', 'integer', Rule::exists('destinations', 'id')->where(fn ($query) => $query->where('is_country_root', false)->orWhereNull('is_country_root'))],
